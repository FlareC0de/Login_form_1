...
heading=Label(frame,text='Sign in',fg='#57a1f8',bg='white',font=('Poppins',23,'bold'))
...
label=Label(frame,text="Don't have an account?",bg='white',font=('Poppins',9))
label.place(x=75,y=290)

sign_up=Button(frame,width=6,text='Sign up',border=0,bg='white',cursor='hand2',fg='#57a1f8')
sign_up.place(x=205,y=290)
